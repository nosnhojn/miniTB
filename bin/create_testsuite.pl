...
sub CreateTestSuite() {
  ...
  print OUTFILE "  miniTB_testsuite miniTB_ts;\n";
  print OUTFILE "  \n";
  print OUTFILE "  \n";
  print OUTFILE "  //===================================\n";
  ...
  print OUTFILE "    miniTB_ts = new(name);\n";
  foreach $item ( @instance_names ) {
    print OUTFILE "    miniTB_ts.add_logger($item.logger);\n";
    $cnt++;
  }
  ...
  print OUTFILE "    miniTB_ts.run();\n";
  foreach $item ( @instance_names ) {
    print OUTFILE "    $item.run();\n";
    $cnt++;
  }
  print OUTFILE "    miniTB_ts.report();\n";
